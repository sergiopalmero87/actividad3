...
<!-- Creamos el template-->
    ...
    <!-- Creamos una etiqueta instituto la cual englobará todo. Elegimos una estructura que haga más legible la información ya que está más ordenada.-->
        <instituto>
            ...
            <xsl:attribute name="nombre"><xsl:value-of select="@nombre"></xsl:value-of></xsl:attribute>
            <xsl:attribute name="web"><xsl:value-of select="@web"></xsl:value-of></xsl:attribute>
            ...
            <!-- Creamos etiqueta director y dentro las etiquetas id y nombre con los valores del xml antiguo.-->
                <director>
                    <id><xsl:value-of select="director/id"></xsl:value-of></id>
            ...
            <!-- Creamos etiqueta jefe_estudios y dentro las etiquetas nombre y despacho con los valores del xml antiguo.-->
                <jefe_estudios>
                    ...
                    <despacho><xsl:value-of select="jefe_estudios/despacho"></xsl:value-of></despacho>
                </jefe_estudios>
            ...
            <ciclos>
                <xsl:for-each select="ciclos">
                    <ciclo>
                        ...
                        <nombre><xsl:value-of select="ciclos/ciclo/nombre"></xsl:value-of></nombre>
                        <grado><xsl:value-of select="ciclos/ciclo/grado"></xsl:value-of></grado>
                        <decretoTitulo>
                            <xsl:attribute name="año"><xsl:value-of select="@año"></xsl:value-of></xsl:attribute>
                        </decretoTitulo>
                    </ciclo>
                </xsl:for-each>
            </ciclos>
